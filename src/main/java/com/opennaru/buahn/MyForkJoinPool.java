...
public class MyForkJoinPool extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(System.getenv("REMOTE_URL") != null) {
			if(System.getenv("REMOTE_URL").equals("true")) {
		...
		} else if(System.getenv("REVIEW_URL") != null) {
			if(System.getenv("REVIEW_URL").equals("true")) {
				apiInfos.put("review-v1", "http://" + System.getenv("REVIEW_V1_URL"));
				apiInfos.put("review-v2", "http://" + System.getenv("REVIEW_V2_URL"));	
			}
		} else {
    ...
    private static class ApiRequestTask extends RecursiveTask<Map<String, String>> {
      ...
      private Map<String, String> sendRequest(Map<String, String> apiInfos) {
    	  /*
    	   * return MAP API NAME, API Response Body
    	   */
	      ...
	      try {
              ...
              if (statusCode == HttpStatus.SC_OK) {
            	  ...
            	  apiResponse.put(apiName, Integer.toString(statusCode));
            	  return apiResponse;
